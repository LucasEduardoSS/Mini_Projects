    ...
    if o1 in [1, 2]:
        ...
        if o1 == 1:
            ...
            for i in range(qnt_tarefas):
                tarefas.append(
                    {
                        "Nome": str(input(f"Informe o nome da {i + 1}° tarefa: ")),
                        "Peso": int(input(f"Informe o peso dessa {i + 1}° tarefa: ")),
                    }.copy()
                )
            ...
            for o in range(qnt_pessoas):
                pessoas.append(
                    {
                        "Nome": str(input(f"Informe o nome da {o + 1}° pessoa: ")),
                        "Tarefas": [],
                        "Peso das Tarefas": 0,
                    }
                )
        ...
        for p in pessoas:
            ...
            while len(tarefas_analisadas) < (len(tarefas) - len(tarefas_atribuidas)):
                ...
                if p["Peso das Tarefas"] + temp_tar["Peso"] <= peso_medio:
                    ...
                    if o1_1 in "Ss":
                        print(
                            f'Tarefa {temp_tar["Nome"]} atribuida a {p["Nome"]}.'
                        ), sleep(3)
    ...
    2 - Pessoas        
            ...
            if o4_1 == 1:
                ...
                for i in range(qnt_reg):
                    tarefas.append(
                        {"Nome": str(input("Nome: ")), "Peso": int(input("Peso: "))}
                    )
